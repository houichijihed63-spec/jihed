/****************************************************************************
** Meta object code from reading C++ file 'OcrClient.h'
**
...
#error "The header file 'OcrClient.h' doesn't include <QObject>."
...
template <> constexpr inline auto OcrClient::qt_create_metaobjectdata<qt_meta_tag_ZN9OcrClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'finished'
        QtMocHelpers::SignalData<void(OcrResult)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'progress'
...
void OcrClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->finished((*reinterpret_cast<std::add_pointer_t<OcrResult>>(_a[1]))); break;
        case 1: _t->progress((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (OcrClient::*)(OcrResult )>(_a, &OcrClient::finished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (OcrClient::*)(const QString & )>(_a, &OcrClient::progress, 1))
            return;
    }
}
...
// SIGNAL 0
void OcrClient::finished(OcrResult _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void OcrClient::progress(const QString & _t1)
{
