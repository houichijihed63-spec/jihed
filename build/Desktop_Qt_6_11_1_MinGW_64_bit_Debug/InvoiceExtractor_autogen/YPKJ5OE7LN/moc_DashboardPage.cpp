...
template <> constexpr inline auto DashboardPage::qt_create_metaobjectdata<qt_meta_tag_ZN13DashboardPageE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "invoiceId",
        "deleteInvoiceRequested"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'newInvoiceRequested'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'editInvoiceRequested'
        QtMocHelpers::SignalData<void(int)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 4 },
        }}),
        // Signal 'deleteInvoiceRequested'
...
void DashboardPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->editInvoiceRequested((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->deleteInvoiceRequested((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DashboardPage::*)()>(_a, &DashboardPage::newInvoiceRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DashboardPage::*)(int )>(_a, &DashboardPage::editInvoiceRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (DashboardPage::*)(int )>(_a, &DashboardPage::deleteInvoiceRequested, 2))
            return;
    }
}
...
// SIGNAL 1
void DashboardPage::editInvoiceRequested(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void DashboardPage::deleteInvoiceRequested(int _t1)
{
